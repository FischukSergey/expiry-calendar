...
Преподаватель клонирует репозиторий и поднимает стек одной командой. Текущая защита — ветка `main` (свои данные, оплата вхождения, CD). Историческая сдача Sprint 6 — тег [`v1.0.0`](https://github.com/FischukSergey/expiry-calendar/releases/tag/v1.0.0) (общий каталог); для комиссии и на прод её не поднимаем.
