...
Спринты 1–7 закрыты по чеклистам (v1 + свои данные). Sprint 8 — CD на VPS. Sprint 9 — продукт (оплачено / тип mobile / notify off / лента); код не начинать, пока пользователь не попросил.
