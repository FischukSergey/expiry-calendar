...
import { billingLabel, findCategoryName, flattenCategories, formatDate, formatMoney } from '../lib/format.ts'
...
export function ItemsPage() {
  ...
  return (
    <div>
      ...
      {items.isError ? <PageState title="Ошибка списка" hint={items.error.message} /> : null}
